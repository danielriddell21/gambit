...
# regenerate the demo GIFs under docs/demos
demos:
    go run ./tools/gifgen -white minimax -black random -seed 7 -out docs/demos/minimax-vs-random.gif
    go run ./tools/gifgen -white minimax -black minimax -depth 3 -seed 1 -out docs/demos/minimax-vs-minimax.gif
